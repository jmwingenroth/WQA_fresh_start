...
for (i in seq_along(crp_files)) {
    ...
    huc12_enroll_area[[i]] <- exact_extract(crp, hucs, include_cols = "huc12") %>%
...
huc12_enroll_area %>% bind_rows() %>% write_fst("data/intermediate/crp_enroll_by_huc12_messy.fst")
